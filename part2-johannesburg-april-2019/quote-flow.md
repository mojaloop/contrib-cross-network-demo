## WIP - Document is Work in progress to determine handling fees and commisions in quote with intermiediary
...
# Handling fees and commissions for Quote Request with intermiediary (FXP)

### Problem

How to handle fee and commision information when intermediteries are involved in an end-to-end quote

### Setup

Sending a quote request from `FSP pink` to `FSP Red` that is routed via an intermidaerty `FXP` to allow for currency conversion of a Non-Disclosing of fees structured fixed SEND
