...
describe('Mojaloop Http Endpoint Manager getEndpoint', function () {
  ...
  beforeEach(function () {
    ...
    httpServer.start()
    endpointManager = new MojaloopHttpEndpointManager(httpServer, { getStoredTransferById: (id: string) => requestMapEntry, getStoredQuoteById: (id: string) => requestMapEntry, getStoredQuotePutById : (id: string) => requestMapEntry, mapOutgoingTransferToIncoming: (id: string) => requestMapEntry })
